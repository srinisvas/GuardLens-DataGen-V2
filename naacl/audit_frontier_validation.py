...
from frontier_validation import TERMINAL_STATUSES, validation_config


def _audit_record(record, *, target_model, judge_model, judge_max_model_len, judge_max_context_chars):
...
def audit_record(record, *, target_model, judge_model, judge_max_model_len, judge_max_context_chars):
    _audit_record(record, target_model=target_model, judge_model=judge_model,
                  judge_max_model_len=judge_max_model_len, judge_max_context_chars=judge_max_context_chars)
